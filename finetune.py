...
def linear_finetune(num_epochs, net, data_loader, train_optimizer, args, train=True, linear_temperature=0.1, logging=None):
    ...
    for i in range(1, num_epochs + 1):
        ...
        torch.save(net.state_dict(), os.path.join(args.results_dir, '{}.pth'.format(logging)))
...
if __name__ == '__main__':
    ...
    loss, top1_acc = linear_finetune(10, linear_eva_model, valid_loader, eva_optimizer, args, train=True,
                                               logging='linear_eva')
